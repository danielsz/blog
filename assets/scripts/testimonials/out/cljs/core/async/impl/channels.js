...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17929 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17929 = (function (val,box,meta17930){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17929.cljs$lang$type = true;
cljs.core.async.impl.channels.t17929.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17929";
cljs.core.async.impl.channels.t17929.cljs$lang$ctorPrWriter = (function (this__7613__auto__,writer__7614__auto__,opt__7615__auto__){return cljs.core._write.call(null,writer__7614__auto__,"cljs.core.async.impl.channels/t17929");
});
cljs.core.async.impl.channels.t17929.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17929.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17931){var self__ = this;
var _17931__$1 = this;return self__.meta17930;
});
cljs.core.async.impl.channels.t17929.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17931,meta17930__$1){var self__ = this;
var _17931__$1 = this;return (new cljs.core.async.impl.channels.t17929(self__.val,self__.box,meta17930__$1));
});
cljs.core.async.impl.channels.__GT_t17929 = (function __GT_t17929(val__$1,box__$1,meta17930){return (new cljs.core.async.impl.channels.t17929(val__$1,box__$1,meta17930));
});
}
return (new cljs.core.async.impl.channels.t17929(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__7616__auto__,writer__7617__auto__,opts__7618__auto__){return cljs.core._write.call(null,writer__7617__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__7613__auto__,writer__7614__auto__,opt__7615__auto__){return cljs.core._write.call(null,writer__7614__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_17932 = self__.takes.pop();if((taker_17932 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17932))
{var take_cb_17933 = cljs.core.async.impl.protocols.commit.call(null,taker_17932);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17933,taker_17932){
return (function (){return take_cb_17933.call(null,null);
});})(take_cb_17933,taker_17932))
);
} else
{}
{
