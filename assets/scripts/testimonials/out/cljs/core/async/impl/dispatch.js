...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17923 = 0;while(true){
var m_17924 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17924 == null))
{} else
{m_17924.call(null);
if((count_17923 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17925 = (count_17923 + 1);
count_17923 = G__17925;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7034__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7034__auto__)
