...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__7613__auto__,writer__7614__auto__,opt__7615__auto__){return cljs.core._write.call(null,writer__7614__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17888 = 0;while(true){
if((i_17888 < arr.length))
{(arr[i_17888] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__7613__auto__,writer__7614__auto__,opt__7615__auto__){return cljs.core._write.call(null,writer__7614__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_17895 = (self__.level + 1);while(true){
if((i_17895 <= (new_level + 1)))
{(update[i_17895] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17897 = 0;while(true){
if((i_17897 <= self__.level))
{var links_17898 = (update[i_17897]).forward;if(((links_17898[i_17897]) === x__$1))
{(links_17898[i_17897] = (x__$1.forward[i_17897]));
{
var G__17899 = (i_17897 + 1);
i_17897 = G__17899;
continue;
}
} else
{{
var G__17900 = (i_17897 + 1);
i_17897 = G__17900;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7046__auto__ = (cljs.core.truth_((function (){var and__7034__auto__ = me;if(cljs.core.truth_(and__7034__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7034__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7046__auto__))
